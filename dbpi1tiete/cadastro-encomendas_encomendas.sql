...
CREATE TABLE `encomendas` (
  ...
  `casa` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `telefone` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo_encomenda` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `data_entrega` date NOT NULL,
  `loja` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2021-11-28  7:46:44
